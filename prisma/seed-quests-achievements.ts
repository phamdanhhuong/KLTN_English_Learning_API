...
export async function seedQuestsAndAchievements() {
  ...
  const achievementDefinitions = [
    ...
    // Asset: no_mistake_doing.png / no_mistake_done.png
    {
      ...
      category: 'perfect_lesson_streak',
      tier: 1,
      requirement: 3,
      rewardXp: 40,
      rewardGems: 5,
    ...
    // Asset: mistake_mechanic_doing.png / mistake_mechanic_done.png
    {
      ...
      category: 'mistake_correction_count',
      tier: 1,
      requirement: 20,
      rewardXp: 50,
      rewardGems: 5,
    ...
    // Asset: quest_explorer_doing.png / quest_explorer_done.png
    {
      ...
      category: 'quest_completed_count',
      tier: 1,
      requirement: 5,
      rewardXp: 40,
      rewardGems: 5,
    ...
    {
      key: 'most_lessons_in_day',
      name: 'Most Lessons',
      description: 'Số bài học nhiều nhất trong 1 ngày',
      category: 'personal',
      tier: 1,
      requirement: 5,
      rewardXp: 100,
    ...
    {
      key: 'most_perfect_in_row',
      name: 'Perfect Streak',
      description: 'Chuỗi bài hoàn hảo liên tiếp dài nhất',
      category: 'personal',
      tier: 1,
      requirement: 5,
      rewardXp: 100,
    ...
    {
      key: 'fastest_perfect_lesson',
      name: 'Fastest Perfect',
      description: 'Thời gian hoàn thành bài học hoàn hảo nhanh nhất (giây)',
      category: 'personal',
      tier: 1,
      requirement: 120,
      rewardXp: 100,
  ...
  const questDefinitions = [
    ...
    // Social Quests
    {
      ...
      category: 'XP_EARNED' as any,
      name: 'Team XP Goal',
      description: 'Earn 500 XP together',
      baseRequirement: 500,
      rewardXp: 100,
      rewardGems: 10,
      chestType: 'SILVER' as any,
    ...
    },
    {
      ...
      type: 'FRIENDS' as any,
      category: 'XP_EARNED' as any,
      name: 'Ultimate Team XP',
      description: 'Earn 1500 XP together',
